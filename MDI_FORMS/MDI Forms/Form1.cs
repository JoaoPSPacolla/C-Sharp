    ...
    public partial class Form1 : Form
    {
        ...
        private void calcularCombustívelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (Application.OpenForms.OfType<Form2>().Count() == 0)
            {
                ...
                filho2.MdiParent = this; //Voce está vinculando o form2 ao form1 (o this é o form1)
                filho2.Show();
            }
        }

        private void calcularOleoToolStripMenuItem_Click(object sender, EventArgs e)
        {
